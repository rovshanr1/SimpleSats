...
struct CoinGeckoModel: Codable, Identifiable {
...
extension CoinGeckoModel {
    static let mock: CoinGeckoModel = CoinGeckoModel(
        id: "bitcoin",
        symbol: "btc",
        name: "Bitcoin",
        ...
        sparklineIn7D: SparklineIn7D(price: [67000, 68000, 69000]),
